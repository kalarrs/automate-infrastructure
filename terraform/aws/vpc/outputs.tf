...
//  description = "The association ID for the IPv6 CIDR block"
//  value       = module.vpc.default_vpc_ipv6_association_id
//}
//
//output "default_vpc_ipv6_cidr_block" {
//  description = "The IPv6 CIDR block"
//  value       = module.vpc.default_vpc_ipv6_cidr_block
//}
...
output "private_and_public_route_table_ids" {
  value = concat(module.vpc.public_route_table_ids, module.vpc.private_route_table_ids)
}
output "private_and_public_route_table_ids_count" {
  value = length(concat(module.vpc.public_route_table_ids, module.vpc.private_route_table_ids))
}
